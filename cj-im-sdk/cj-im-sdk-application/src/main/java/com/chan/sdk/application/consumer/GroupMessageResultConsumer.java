 ...
 * FileName: GroupMessageResultConsumer
 * Description:
 */
@Component
...
public class GroupMessageResultConsumer extends BaseMessageResultConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String msg) {
        if (StrUtil.isBlank(msg)) {
            logger.warn("GroupMessageResultConsumer.onMessage 接收的消息为空");
            return;
        }
        ...
        messageListenerMultiCaster.multicast(IMListenerType.GROUP_MESSAGE, resultMessage);
    }
}
